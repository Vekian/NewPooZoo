...
--
CREATE DATABASE IF NOT EXISTS `pokemonzoo` DEFAULT CHARACTER
SET
...
VALUES
  (
    ...
    'Propre',
    'Reserve',
    'public/images/reserve.jpg',
    7,
    6
  ),
  (
    34,
    'Enclos de la poiscaille',
    'Propre',
    'Aquarium',
    'public/images/aquarium.jpg',
    2,
    6
  ),
  (
...
CREATE TABLE
  IF NOT EXISTS `species` (
    ...
    SET
      ...
      `diet` varchar(30) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
      `Type1` varchar(30) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
      `Type2` varchar(30) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
      `avatar` varchar(50) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
      ...
      `nameEvolution` varchar(30) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
--
INSERT INTO
  `staff` (`id`, `nameEmployee`, `age`, `sex`, `zoo_id`)
VALUES
  (6, 'Robert', 20, 'male', 6),
...
CREATE TABLE
  IF NOT EXISTS `zoo` (
    ...
    `summary` varchar(500) COLLATE utf8mb4_general_ci NULL,
...
VALUES
  (
    6,
    'Zoo de Roanne',
    '$2y$10$WyPP3Ik4vNh0qwOVeYmkmeYM7ugHV94MW4.rivSo4nqd766.Yg9S.',
    4,
    -8444,
    162,
    291
  ...
  (
    7,
    'Zoo de Hamza',
    '$2y$10$HSoYXY4Q1iTdp6EH9T/vg.aYZT07rqooFB0/94qLiin1R.ldPymBm',
    4,
    231,
    7,
    115
  ...
  (
    8,
    'Zoo de Mélanie',
    '$2y$10$GildiSD0wnKAmo5ITMt9auyB.gs.I5yRhMOk5sr198wy2E8pfjRB.',
    4,
    25,
    1,
    25
  ...
  (
    9,
    'Zoo de quentin',
    '$2y$10$oD48qarcLiNLJEdLKKFrxeS08o7UT/JQP/zKB4LNBdQ0X.LowvXoG',
    4,
    -66,
    10,
    130
...
--
ALTER TABLE `fences` ADD CONSTRAINT `fence_of_zoo` FOREIGN KEY (`zoo_id`) REFERENCES `zoo` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `pokemons`
--
ALTER TABLE `pokemons` ADD CONSTRAINT `fence_of_animal` FOREIGN KEY (`fence_id`) REFERENCES `fences` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT `species_of_animal` FOREIGN KEY (`species_id`) REFERENCES `species` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `staff`
--
ALTER TABLE `staff` ADD CONSTRAINT `zoo_of_staff` FOREIGN KEY (`zoo_id`) REFERENCES `zoo` (`id`) ON DELETE CASCADE;
