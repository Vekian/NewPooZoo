...
?></li>
                ...
                <a href="index.php" class=" offset-xxl-4 offset-xl-3 offset-lg-3"><img src="public/images/logo.png"  id="logo"></a>
                ...
                <div class="collapse navbar-collapse " id="navbarNavDropdown">
                    <ul class="navbar-nav d-flex flex-row justify-content-around ms-auto align-items-center">
                        ...
                        <div id="gameInfos" class="text-light nav-link ">
                            ...
                            <h5><?php echo($pokemonZoo->getPokedollars()) ?><img src="public/images/pokedollar.png" height="30px" class="ms-2"></h5>
                        </div>
                        <?php } ?>
                        </li>
                    </ul>
